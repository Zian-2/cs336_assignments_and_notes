...
完成后，根目录下运行uv run pytest tests/test_train_bpe.py。速度参考：
```PowerShell
   Ordered by: cumulative time
   List reduced from 429 to 15 due to restriction <15>

   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
        1    0.005    0.005    1.354    1.354 D:\cs336_assignments_and_notes\assignment1-basics\cs336_basics\tokenizer.py:172(train)
      243    0.387    0.002    1.015    0.004 D:\cs336_assignments_and_notes\assignment1-basics\cs336_basics\tokenizer.py:146(merge_step)
        1    0.000    0.000    0.325    0.325 D:\cs336_assignments_and_notes\assignment1-basics\cs336_basics\tokenizer.py:76(counting_init)
        1    0.000    0.000    0.260    0.260 D:\Program Files\Python313\Lib\multiprocessing\pool.py:738(__exit__)
        1    0.000    0.000    0.258    0.258 D:\Program Files\Python313\Lib\multiprocessing\pool.py:654(terminate)
      503    0.131    0.000    0.238    0.000 {built-in method builtins.max}
    33439    0.141    0.000    0.193    0.000 D:\cs336_assignments_and_notes\assignment1-basics\cs336_basics\tokenizer.py:107(_replace_pair_and_pair_counts)
       21    0.000    0.000    0.128    0.006 D:\Program Files\Python313\Lib\multiprocessing\util.py:272(__call__)
  1157444    0.128    0.000    0.128    0.000 {method 'get' of 'dict' objects}
        1    0.000    0.000    0.127    0.127 D:\Program Files\Python313\Lib\multiprocessing\pool.py:305(_repopulate_pool)
        1    0.000    0.000    0.127    0.127 D:\Program Files\Python313\Lib\multiprocessing\pool.py:314(_repopulate_pool_static)
       20    0.000    0.000    0.126    0.006 D:\Program Files\Python313\Lib\multiprocessing\process.py:110(start)
        1    0.000    0.000    0.126    0.126 D:\Program Files\Python313\Lib\multiprocessing\pool.py:680(_terminate_pool)
       20    0.000    0.000    0.126    0.006 D:\Program Files\Python313\Lib\multiprocessing\context.py:334(_Popen)
       20    0.001    0.000    0.123    0.006 D:\Program Files\Python313\Lib\multiprocessing\popen_spawn_win32.py:46(__init__)
